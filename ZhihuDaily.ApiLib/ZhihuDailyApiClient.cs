...
namespace ZhihuDaily.ApiLib
{
    public class ZhihuDailyApiClient
    {
        ...
        {
            internal const string BaseUrl = "http://news-at.zhihu.com/api/4";
            ...
            /// 主题列表
            /// </summary>
            internal static string _topicsUrl = $"{BaseUrl}/themes";
            ...
            /// 分页获取长评论
            /// </summary>
            internal static string _beforeLongCommentsUrl = $"{BaseUrl}/story/{0}/long-comments/before/{1}"; //0 文章id  1 评论id
